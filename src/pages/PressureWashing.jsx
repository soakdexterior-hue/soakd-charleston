...
export default function PressureWashing() {
  return (
    <>
      <SEO
        title="Pressure Washing Charleston SC | Soakd Exterior"
        description="Expert pressure washing in Charleston SC. House washing, driveway cleaning & more. Fast response. Free quote at 843-826-6708."
        canonical="/pressure-washing"
      />
      <section className="relative overflow-hidden bg-primary">
        <div className="absolute inset-0 opacity-20">
          <img src="https://media.base44.com/images/public/69bdabf65e992908c9993001/db442dc11_generated_01ad29cc.png" alt="Professional pressure washing service in Charleston SC" className="w-full h-full object-cover" />
        </div>
