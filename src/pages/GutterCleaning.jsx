    ...
    <>
      <section className="relative overflow-hidden bg-primary">
        <div className="absolute inset-0 opacity-20">
          <img src="https://media.base44.com/images/public/69bdabf65e992908c9993001/f83ec5140_generated_9c30a3c3.png" alt="Gutter cleaning service in Charleston SC" className="w-full h-full object-cover" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <img src="https://media.base44.com/images/public/69bdabf65e992908c9993001/f83ec5140_generated_9c30a3c3.png" alt="Gutter cleaning in Charleston" className="w-full" />
              </div>
