    ...
    <>
      <section className="relative overflow-hidden bg-primary">
        <div className="absolute inset-0 opacity-20">
          <img src="/__generating__/img_ecc1b86a396f.png" alt="Soft washing service in Charleston SC" className="w-full h-full object-cover" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <img src="/__generating__/img_ecc1b86a396f.png" alt="Soft washing a Charleston home" className="w-full" />
              </div>
