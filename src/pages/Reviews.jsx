...
const ALL_REVIEWS = [
  ...
  { name: 'Michael P.', date: 'Google Review', text: 'Had our gutters cleaned before hurricane season. The team was thorough, professional, and left everything spotless. We\'ll definitely be using Soakd again. Best service in Summerville!' },
  { name: 'Amanda W.', date: 'Google Review', text: 'The soft washing they did on our house was amazing. All the algae and mildew is gone, and it looks like we just painted the house. Incredible results on our Daniel Island home.' },
  { name: 'Robert K.', date: 'Google Review', text: 'Fast response, fair pricing, and excellent work. What more could you ask for? Our windows on James Island sparkle like never before.' },
  { name: 'Jennifer H.', date: 'Google Review', text: 'We had Soakd clean our windows and pressure wash the pool deck. Both came out perfect. They were done in half the time I expected and the quality was outstanding.' },
  { name: 'David L.', date: 'Google Review', text: 'Called on a Monday morning and they were at our Goose Creek home by Wednesday. The window cleaning was flawless. Our home feels brighter inside now. Thank you Soakd!' },
  { name: 'Karen S.', date: 'Google Review', text: 'Finally found a company that does what they say they\'ll do. Soakd pressure washed our entire driveway and walkway in Isle of Palms. It looks brand new. Five stars all the way.' },
  { name: 'Chris B.', date: 'Google Review', text: 'The crew was friendly, professional, and incredibly efficient. They soft washed our home in Folly Beach and it looks fantastic. Best cleaning company in the Lowcountry!' },
  { name: 'Patricia N.', date: 'Google Review', text: 'Our Sullivans Island cottage needed a deep clean. Soakd handled everything — windows, gutters, and soft washing. The results exceeded every expectation. Highly recommend!' },
  { name: 'Thomas G.', date: 'Google Review', text: 'Quick to schedule, on time, and delivered amazing results on our Seabrook Island home. Our windows are crystal clear and the whole exterior looks refreshed. Will use again!' },
];
  ...
  return (
    <>
      <SEO
        ...
        description="Read 150+ five-star reviews from homeowners across Charleston, Summerville, Mount Pleasant and the Lowcountry. See why Soakd is the most trusted exterior cleaning company in Charleston SC."
        canonical="/reviews"
      />
      {/* Hero */}
