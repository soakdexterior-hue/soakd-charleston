          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                With 170+ five-star reviews and the fastest response time in the Lowcountry, our reputation speaks for itself — built one clean window, one sparkling driveway, and one happy homeowner at a time.
              </p>
