...
export default function WindowCleaning() {
  return (
    <>
      <SEO
        title="Professional Window Cleaning Charleston SC | Soakd"
        description="Professional residential window cleaning in Charleston, Summerville & Mount Pleasant SC. Clean Window Guarantee. Free quotes. Call 843-826-6708."
        canonical="/window-cleaning"
      />
      {/* Hero */}
      <section className="relative overflow-hidden bg-primary">
        <div className="absolute inset-0 opacity-20">
          <img src="https://media.base44.com/images/public/69bdabf65e992908c9993001/cb3a1e018_generated_67b0b0b3.png" alt="Professional window cleaning service in Charleston SC" className="w-full h-full object-cover" />
        </div>
